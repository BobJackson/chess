...
miniprogram/
  ...
  ui/
    ...
    endgame.js               绝杀演出：三拍时间线 + 11 种杀法母题 + 结算卡
  audio/
...
杀法的测试局面（11 个已用引擎确认过的将死局面）放在 `scripts/fixtures/mate-cases.js`，
